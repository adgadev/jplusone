...
package com.adgadev.jplusone.asserts.context.stub;
...
@Getter
@Builder
public class OperationNodeStub implements OperationNodeView {

    private final OperationType operationType;

    private final FrameStack callFramesStack;

    private final List<LazyInitialisation> lazyInitialisations;

    private final List<StatementNodeStub> statements;
