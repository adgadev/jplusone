...
import com.adgadev.jplusone.asserts.context.stub.RootNodeStub;
...
public class RootNodeMother {

    public static RootNodeStub anyRootNode() {
        return anyRootNode(anySessionNodeWithImplicitOperation());
    }

    public static RootNodeStub anyRootNode(SessionNodeStub session) {
