...
class CommerceServiceTest {
    ...
    void shouldLoadVariousObjects() {
        ...
        assertThat(sessionNode.getSessionFrameStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(CommerceServiceTest.class, "shouldLoadVariousObjects"),
                anyProxyMethodCallFrame(CommerceService.class, "loadVariousObjects")
        )));
        ...
        assertThat(operationNodeView1.getCallFramesStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(CommerceService.class, "loadVariousObjects"),
        ...
        assertThat(operationNodeView3.getCallFramesStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(CommerceService.class, "loadVariousObjects"),
                anyProxyMethodCallFrame(ClientProfile.class, "getPhotoLink")
        )));
        ...
        assertThat(operationNodeView4.getCallFramesStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(CommerceService.class, "loadVariousObjects")
        )));
        ...
        assertThat(operationNodeView5.getCallFramesStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(CommerceService.class, "loadVariousObjects")
        )));
        ...
        assertThat(operationNodeView6.getCallFramesStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(CommerceService.class, "loadVariousObjects"),
                anyProxyMethodCallFrame(Manufacturer.class, "getName")
        )));
