...
class EntityManagerCrudServiceTest {
    ...
    void shouldAddManufacturer() {
        ...
        assertThat(sessionNode.getSessionFrameStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(EntityManagerCrudServiceTest.class, "shouldAddManufacturer"),
                anyProxyMethodCallFrame(EntityManagerCrudService.class, "addManufacturer"),
                anyThirdPartyMethodCallFrame(AbstractPlatformTransactionManager.class, "commit")
        )));
        ...
        assertThat(operationNodeView.getCallFramesStack(), allFrameCallMatcher(notAppMethodCallFrame()));
        assertThat(operationNodeView.getCallFramesStack(), frameCallSequenceMatcher(List.of(
    ...
    void shouldUpdateManufacturerNameByMerge() {
        ...
        assertThat(sessionNode.getSessionFrameStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(EntityManagerCrudServiceTest.class, "shouldUpdateManufacturerNameByMerge"),
                anyProxyMethodCallFrame(EntityManagerCrudService.class, "updateManufacturerNameByMerge")
        )));
        ...
        assertThat(operationNodeView1.getCallFramesStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(EntityManagerCrudService.class, "updateManufacturerNameByMerge"),
    ...
    void shouldUpdateManufacturerNameOnManagedEntity() {
        ...
        assertThat(sessionNode.getOperations(), hasSize(equalTo(2)));
        assertThat(sessionNode.getSessionFrameStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(EntityManagerCrudServiceTest.class, "shouldUpdateManufacturerNameOnManagedEntity"),
                anyProxyMethodCallFrame(EntityManagerCrudService.class, "updateManufacturerNameOnManagedEntity")
        )));
        ...
        assertThat(operationNodeView1.getLazyInitialisation(), nullValue());
        assertThat(operationNodeView1.getCallFramesStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(EntityManagerCrudService.class, "updateManufacturerNameOnManagedEntity"),
    ...
    void shouldDeleteManufacturer() {
        ...
        assertThat(sessionNode.getSessionFrameStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(EntityManagerCrudServiceTest.class, "shouldDeleteManufacturer"),
                anyProxyMethodCallFrame(EntityManagerCrudService.class, "deleteManufacturer")
        )));
        ...
        assertThat(operationNodeView1.getLazyInitialisation(), nullValue());
        assertThat(operationNodeView1.getCallFramesStack(), frameCallSequenceMatcher(List.of(
                anyAppMethodCallFrame(EntityManagerCrudService.class, "deleteManufacturer"),
                anyThirdPartyMethodCallFrameOnClassAssignableFrom(EntityManager.class, "find"),
                anyThirdPartyMethodCallFrameOnClassAssignableFrom(PreparedStatement.class, "executeQuery")
        )));
